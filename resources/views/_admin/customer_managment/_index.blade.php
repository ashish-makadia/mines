                    ...
                    @csrf   <div class="d-flex w-100 justify-content-between row">
                        ...
                        <div class="mb-3 col-md-6 col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="customer_name" class="form-control" id="basic-icon-default-fullname" aria-describedby="basic-icon-default-fullname2" placeholder="Pinal Kumari"  required/>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="customer_number"  class="form-control" id="basic-icon-default-fullname" aria-describedby="basic-icon-default-fullname2" placeholder="123456789"  required/>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="customer_email" class="form-control" id="basic-icon-default-fullname" aria-describedby="basic-icon-default-fullname2" placeholder="pinal123@gmail.com" required/ >
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-6">
                            ...
                            <input type="text" name="customer_gst" class="form-control" placeholder="24AAAAA0000A1Z5" required>
                        </div>
                        ...
                        <div class="mb-3 col-md-4 col-6">
                            ...
                            <input type="text" name="customer_pan" class="form-control" placeholder="ABCD1234A" required>
                        ...
                        <div class="mb-3 col-md-6 col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="customer_pin" maxlength="6" minlength="6" class="form-control" placeholder="374123" required>
                            </div>
                        </div>
...
<div class="modal fade" id="response2">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('add-customer-managment')}}" method="post">
                    @csrf    <div class="d-flex w-100 justify-content-between row">
                        ...
                        <div class="mb-3 col-md-6 col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="customer_name" class="form-control" id="basic-icon-default-fullname" aria-describedby="basic-icon-default-fullname2" placeholder="Customer Name"  required> 
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="customer_number"  class="form-control" id="basic-icon-default-fullname" aria-describedby="basic-icon-default-fullname2" placeholder="Customer Number"  required/>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-12">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="customer_email" class="form-control" id="basic-icon-default-fullname" aria-describedby="basic-icon-default-fullname2" placeholder="Customer Email" required />
                            </div>
                        </div>

                        <div class="mb-3 col-md-6 col-6">
                            <label for="exampleInputPassword6">Gst Number<span class="text-red">*</span></label>
                            <input type="text" name="customer_gst" class="form-control" placeholder="Ex.24AAAA0000A1Z11" required>
                        </div>
                        ...
                        <div class="mb-3 col-md-4 col-6">
                            <label for="exampleInputPassword6">Pan Number<span class="text-red">*</span></label>
                            <input type="text" name="customer_pan" class="form-control" placeholder="Ex.ABCD1234A" required>
                        ...
                        <div class="mb-3 col-md-12 col-12">
                            <label for="exampleInputPassword6">Address</label>
                            <textarea name="customer_addr" value="" class="form-control" placeholder="Address" rows="3"></textarea>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="customer_pin"   maxlength="6" minlength="6"  class="form-control" placeholder="Ex.123456 " required>
                            </div>
                        </div>
