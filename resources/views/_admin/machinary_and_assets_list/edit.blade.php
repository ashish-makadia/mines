                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3 col-md-4 col-6">
                                        ...
                                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="date_of_purchase" value="{{date('d-m-Y', strtotime($data->date_of_purchase)) }}"  data-target="#reservationdate" placeholder="Date Of Purchased" />
                                    ...
                                    <div class="form-group mb-3 col-md-4 col-6">
                                        ...
                                        <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" name="warranty_expiration" value="{{date('d-m-Y', strtotime($data->warranty_expiration)) }}" data-target="#reservationdate1" placeholder="Warranty Expiration" />
                                    ...
                                    <div class="mb-3 col-md-4 col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="achine_asset_price" value="{{$data->achine_asset_price}}"  id="exampleInputPassword4" placeholder="Price" >
                                        </div>
                                    ...
                                    <div class="mb-3 col-md-4 col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="tax_rate" value="{{$data->tax_rate}}"  id="exampleInputPassword5" min="0"  placeholder="Tax Rate" >
                                        </div>
                                        @error('tax_rate')
                                        <div class="text-red">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3 col-md-4 col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" name="total_payble_amount" value="{{$data->total_payble_amount}}"  id="exampleInputPassword5" min="0"  placeholder="Total Payment" >
                                        </div>
