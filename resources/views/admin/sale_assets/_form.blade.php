...
<div class="d-flex w-100 justify-content-between row">
    ...
    <div class="form-group mb-3 col-md-6 col-12">
        ...
        <div class="input-group">
            ...
            <input type="number" step="any" id="quantity" class="form-control assign_qty" readonly placeholder="Enter Quantity"
                name="stock_qty" value="{{ isset($assign_assets->stock_qty) ? $assign_assets->stock_qty : old('stock_qty') }}"
                required>
        </div>
