                ...
                <div class="col-md-12 col-12">
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{route('update-mine')}}" method="POST" id="formAuthentication">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group  mb-1  col-md-4 col-12">
                                        ...
                                        <input type="text" class="form-control" id="mine_area" name="mine_area" value="{{ isset($mine->mine_area)?$mine->mine_area:old('mine_area') }}" placeholder="Area of Mine">
                                        @error('mine_area')
                                        <div class="text-red">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group  mb-1  col-md-4 col-12">
                                        ...
                                        <select class="form-control select2 a3" name="area_unit" >
                                            ...
                                            <option value="{{$unit->id}}" {{ $mine->area_unit == $unit->id || old('area_unit') == $unit->id ? 'selected' : '' }}>{{$unit->uqc_code}}</option>
                                            @endforeach
                                    ...
                                    <div class="mb-3 col-md-4 col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="hsn" value="{{ isset($mine->hsn)?$mine->hsn:"" }}" placeholder="Enter Hsn">
                                        </div>
                                        @error('hsn')
                                        <div class="text-red">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="form-group mb-3 col-md-3 col-12">
                                        ...
                                        <div class="input-group date" id="reservationdate1" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate1" name="mine_purchase_date" value="{{date('d-m-Y', strtotime($mine->mine_purchase_date)) }}" placeholder="Date" />
