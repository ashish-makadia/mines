                            ...
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-10 col-9">
                                        <h4>Add {{ $module_name }}</h4>
                                    </div>
                                    <div class="col-md-2 col-3">
                                        <a href="{{ route("{$module_route}.index") }}" class="btn btn btn-primary btn-sm float-right">{{ $module_name}}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <form class='form-horizontal' method="POST" action="{{ route("{$module_route}.store") }}"
