<form id="step3-form">
                ...
                @foreach ($wip->wip_step3 as $key => $value)
                    <div class="row">
                        ...
                        @if (isset($value->uploaded_pic) && $value->uploaded_pic !="")
                            ...
                            <input type="hidden" name="step3_id" value="{{ $value->id }}" @endif
                            @if ($loop->first) <div class="mb-3 col-md-1 col-12 ">
                    <div>
    ...
    <div class="row">
        ...
        <div class="form-group mb-3 col-md-3 col-12">
            ...
            <input type="number" name="waste_quantity" class="form-control" id="exampleInputwq"
                placeholder="Waste quantity - 150" value="{{ isset($wip->waste_quantity) ? $wip->waste_quantity : '' }}">
        </div>
    ...
    <button type="submit" name="finish_wp" id="finish_wip" value="finish_wp" class="btn btn-success submitBtn">Finish
        W/P</button>
</form>
