    ...
    <div class="row">
        <div class="mb-3 col-md-4 col-12">
            ...
            <div class="input-group">
                ...
                <input type="text" name="finish_good" readonly class="form-control finish_good" placeholder="4 pieces"
                    value="{{ isset($wip->no_of_pieces) ? $wip->no_of_pieces : old('finish_good') }}">
            </div>
        </div>
        <div class="mb-3 col-md-4 col-12">
