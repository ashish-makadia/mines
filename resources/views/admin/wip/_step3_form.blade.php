<form id="step3-form">
    ...
    <div class="row">
        <div class="mb-3 col-md-4 col-12">
            ...
            <div class="input-group">
                ...
                <input type="text" name="finish_good" class="form-control finish_good" placeholder="4 pieces"
        ...
        <div class="mb-3 col-md-4 col-12">
            ...
            <div class="input-group date" id="reservationdate3" data-target-input="nearest">
                <input type="text" name="finished_current_date" class="form-control datetimepicker-input"
                    data-target="#reservationdate3" placeholder="{{ date('d-m-y') }}" readonly
        ...
        <div class="row-container-step3">
            ...
            @else --}}
                <div class="row data_row">
                    <div class="form-group mb-3 col-md-2 col-12">
                        <label for="exampleInputHeight">Height</label>
                        <input type="number" name="height[]" class="form-control height" id="exampleInputheights"
                            placeholder="Enter Height">
                    </div>

                    <div class="form-group mb-3 col-md-2 col-12">
                        <label for="exampleInputWeight">Weight</label>
                        <input type="number" name="weight[]" class="form-control weight" id="exampleInputWeight"
                            placeholder="Enter Weight">
                    </div>

                    <div class="form-group mb-3 col-md-1 col-12">
                        <label for="exampleInputWidth">Width</label>
                        <input type="number" name="width[]" class="form-control width" id="exampleInputWidth"
                            placeholder="Enter Width">
                    </div>

                    <div class="form-group mb-3 col-md-2 col-12">
                        <label for="exampleInputGunfoot">Gunfoot</label>
                        <input type="number" class="form-control gunfoot" id="exampleInputGunfoot" name="gunfoot[]"
                            placeholder="Enter Gunfoot" readonly>
                    </div>
                    ...
                    {{-- <div class="mb-3 col-md-1 col-12"></div> --}}
                    <div class="mb-3 col-md-1 col-12" >
                        <a class="btn btn-info btn-sm add-icon-step3 ml-4">
                            <i class="fas fa-plus-square"></i>
                        </a>
                    </div>
                </div>
    ...
    <div class="row">
    <button type="button" class="btn btn-primary" onclick="setStep(1,'{{ isset($wip->id) ? $wip->id : 0 }}')">Previous</button>
