<div class="d-flex w-100 justify-content-between row">
    ...
    <div class="col-md-6 col-6  mb-3">
        ...
        <div class="input-group date" id="reservationdate1" data-target-input="nearest">
            <input type="text" class="form-control datetimepicker-input" name="stocking__at_date" value="{{isset($data->stocking__at_date)?date("d-m-Y",strtotime($data->stocking__at_date)):old('stocking__at_date')??date("d-m-Y")}}"  data-target="#reservationdate1" placeholder="Select Date" />
    ...
    <div class="mb-3 col-md-6 col-12">
        ...
        <div class="input-group">
            ...
            <input type="number" id="capacity_storage" name="capacity_storage" class="form-control capacity_storage"
    ...
    <div class="mb-3 col-md-6 col-12">
        ...
        <span class="stock_err text-danger"></span>
    </div>
    ...
    <div class="mb-3 col-md-6 col-12">
        ...
        <div class="input-group">
            ...
            <input type="number" name="rate_per_ltr" class="form-control rate_per_ltr"
