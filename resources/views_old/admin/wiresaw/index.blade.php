...
@section('other-scripts')
    ...
    <script>
        ...
        // $("#per_unit_bill, #total_unit").on("keyup",function(){
        //     var totalUnit = $("#total_unit").val();
        //     var perUnitBill = $("#per_unit_bill").val();
        //     console.log(totalUnit," aaaa:: ",perUnitBill);
        //     var totalBill = parseFloat(totalUnit)*parseFloat(perUnitBill);
        //     console.log("totalBill:: ",totalBill);
        //     $("#today_bill").val(totalBill);
        // });
    </script>
@endsection
