    ...
    <div class="d-flex w-100 justify-content-between row">
        ...
        <div class="mb-3 col-md-6 col-12">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control" id="quantity" name="quantity" required placeholder="Enter Total Quantity">
            </div>
        </div>
        ...
        <div class="mb-3 col-md-6 col-12">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control" id="rate" name="rate" required placeholder="Enter Rate">
            </div>
        </div>
        ...
        <div class="mb-3 col-md-6 col-12">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control" name="total_amount" required placeholder="Enter Total Amount">
            </div>
        </div>
