            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"> Designation Department List</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add New Designation Department</h4>
                 ...
                 @csrf   <div class="d-flex w-100 justify-content-between row">
                        ...
                        <div class="col-md-12 col-12  mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="department" class="form-control" placeholder="Add New Department">
                            </div>
                        </div>
                    </div>
