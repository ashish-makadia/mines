    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table class="table">
                ...
                <tr>
                    <td><strong>Machine/Assets Bill:</strong><a href="{{ asset('machineassetsbill/' . $data->machine_assets_bill) }}" target="_blank">{{ $data->machine_assets_bill }}</a></td>
                    <td><strong>Insurance Documents:</strong><a href="{{ asset('insurancefile/' . $data->insurance_file) }}" target="_blank">{{ $data->insurance_file }}</a></td>
                </tr>
                <tr>
                    <td><strong>Date Of Purchased:</strong>{{@$data->date_of_purchase}}</td>
                    <td><strong>Warranty Expiration:</strong>{{@$data->warranty_expiration}}</td>
                </tr>
