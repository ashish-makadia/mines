    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table class="table">
                ...
                <tr>
                    <td><strong>Machine/Assets Bill:</strong><a href="{{ asset('public/machineassetsbill/' . $data->machine_assets_bill) }}" target="_blank">Click Here</a></td>
                    <td><strong>Insurance Documents:</strong><a href="{{ asset('public/insurancefile/' . $data->insurance_file) }}" target="_blank">Click Here</a></td>
                </tr>
                <tr>
                    <td><strong>Date Of Purchased:</strong>
                    @if(isset($data->date_of_purchase))
                    {{date('d-m-Y', strtotime($data->date_of_purchase)) }}
                    @else
                    No Data
                    @endif
                    </td>
                    <td><strong>Warranty Expiration:</strong>
                           @if(isset($data->warranty_expiration))
                    {{date('d-m-Y', strtotime($data->warranty_expiration)) }}
                    @else
                    No Data
                    @endif
                    </td>
