                 ...
                 @csrf   <div class="d-flex w-100 justify-content-between row">
                    ...
                    <div class="form-group mb-3 col-md-6 col-12">
                        ...
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                            <input type="text" class="form-control datetimepicker-input" name="dm_date" value={{date("d-m-y")}} data-target="#reservationdate" placeholder="Select Date" />
                    ...
                    <div class="form-group mb-3 col-md-6 col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Assets Name" id="assets_name" name="assets_name" value="{{ isset($assign_assets->assets_name)?$assign_assets->assets_name:old('assets_name')}}" required readonly>
                        </div>
                    </div>
                    <div class="mb-3 col-md-6 col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="start" name="start" class="form-control" placeholder="Enter Start Value">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 col-md-6 col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="off" name="off" class="form-control" placeholder="Enter Off Value">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 col-md-6 col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" id="time" readonly name="time" class="form-control" placeholder="Enter Time">
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $("#start, #off").on("keyup",function(){
            var start = $("#start").val();
            var off = $("#off").val();
            console.log(start," aaaa:: ",off);
            var time = parseFloat(off)-parseFloat(start);
            $("#time").val(time);
        });
</script>
@endsection
