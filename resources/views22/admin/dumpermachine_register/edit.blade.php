             ...
             @csrf   <div class="d-flex w-100 justify-content-between row">
                    ...
                    <div class="form-group mb-3 col-md-6 col-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Assets Name" id="assets_name" name="assets_name" value="{{ isset($data->assets_name)?$data->assets_name:old('assets_name')}}" required readonly>
                        </div>
                    </div>
