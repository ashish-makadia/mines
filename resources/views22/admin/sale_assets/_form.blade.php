...
<div class="d-flex w-100 justify-content-between row">
    ...
    <div class="form-group  col-md-6 col-12">
        ...
        <select class="form-control select2 a3" name="assets_category" id="assets_category" required>
    ...
    <div class="form-group mb-3 col-md-6 col-12">
        ...
        <div class="input-group">
            ...
            <input type="number" step="any" id="quantity" class="form-control" placeholder="Enter Quantity"
    ...
    <div class="form-group col-md-6 col-12">
        ...
        <select class="form-control select2 a3" name="mine_id" id="mine_id" required>
            ...
            @foreach ($mines as $mine)
                <option value="{{ $mine->id }}" @if (isset($assign_assets->mine_id) && $mine->id == $assign_assets->mine_id) selected @endif>
