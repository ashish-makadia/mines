                    ...
                    @csrf <div class="d-flex w-100 justify-content-between row ">
                        <div class="mb-3 col-md-6 col-12 ">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text" name="vendor_name" class="form-control " value="{{old('vendor_name')}}" id="basic-icon-default-fullname " aria-describedby="basic-icon-default-fullname2 " placeholder="Pinal Kumari " required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-12">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="number " class="form-control" name="vendor_number" value="{{old('vendor_number')}}"  id="vendor_number"   placeholder="123456789 " required/>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-12">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="email " name="vendor_email" value="{{old('vendor_email')}}" class="form-control " id="vendor_email" placeholder="pinal123@gmail.com " required />
                            </div>
                        </div>

                        <div class="mb-3 col-md-6 col-6">
                            <label for="exampleInputPassword6 ">Gst Number <span class="text-red">*</span></label>
                            <input type="text " name="vendor_gst" class="form-control " value="{{old('vendor_gst')}}" placeholder="24AAAAA0000A1Z5 " required>
                        </div>
                        ...
                        <div class="mb-3 col-md-4 col-6">
                            ...
                            <input type="text " name="vendor_pan" class="form-control " id="vendor_pan" value="{{old('vendor_pan')}}" placeholder="ABCD1234A " required>
                        ...
                        <div class="mb-3 col-md-4 col-12 ">
                            ...
                            <select class="form-control select2 a3" id="state-dd1" name="state_id" required>
                        ...
                        <div class="mb-3 col-md-4 col-12">
                            ...
                            <select class="form-control select2 a3" id="city-dd1" name="city_id" required>
                        ...
                        <div class="mb-3 col-md-6 col-6 ">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="number " name="vendor_pin" value="{{old('vendor_pin')}}" maxlength="6" minlength="6" class="form-control " placeholder="374123 " required>
                            </div>
                        </div>

                        <div class="mb-3 col-md-6 col-6 ">
                            <label>Credit Days <span class="text-red">*</span></label>
                            <select name="credit_days" class="form-control select2 a3 " val="" required>
            ...
            <div class="modal-body ">
                <table class="table">
                    <tr>
                        ...
                        <td><strong>Mobile Number :</strong> <span id="vendor_number"></span></td>
                    </tr>
                    <tr>
                        <td><strong>Email Id :</strong> <span id="vendor_email"></span></td>
                        <td><strong>Gst Number :</strong> <span id="vendor_gst"></span></td>
                    </tr>
                    <tr>
                        <td><strong>Pan Number :</strong> <span id="vendor_pan"></span></td>
...
<div class="modal fade" id="response2">
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            ...
            <div class="modal-body ">
                <form action="{{route('add-vendor-managment')}}" method="post" onsubmit="return validateForm();">
                    @csrf <div class="d-flex w-100 justify-content-between row ">
                        <div class="mb-3 col-md-6 col-12">
                            <label class="form-label " for="basic-icon-default-fullname ">
                                Vendor Name
                            ...
                            <div class="input-group ">
                                ...
                                <input type="text " name="vendor_name" value="{{old('vendor_name')}}" class="form-control " id="basic-icon-default-fullname " aria-describedby="basic-icon-default-fullname2 " placeholder="Vendor Name"  required />
                            </div>
                        </div>
                        ...
                        <div class="mb-3 col-md-6 col-6 ">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="number" name="vendor_number" value="{{old('vendor_number')}}"  class="form-control " id="vendor_number"  placeholder="Vendor Number" required/>
                        ...
                        <div class="mb-3 col-md-6 col-6 ">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="email" name="vendor_email" value="{{old('vendor_email')}}" class="form-control " id="vendor_email"  placeholder="Vendor Email" required/>
                        ...
                        <div class="mb-3 col-md-6 col-12 ">
                            <label for="exampleInputPassword6 ">Gst Number <span class="text-red">*</span></label>
                            <input type="text " name="vendor_gst" value="{{old('vendor_gst')}}" id="vendor_gst" class="form-control " placeholder="Ex.24AAAA0000A1Z11" required>
                        ...
                        <div class="mb-3 col-md-4 col-12 ">
                            <label for="exampleInputPassword6 ">Pan Number <span class="text-red">*</span></label>
                            <input type="text " name="vendor_pan" value="{{old('vendor_pan')}}" id="vendor_pan" class="form-control " placeholder="Ex.ABCD1234A" required>
                        ...
                        <div class="form-group  mb-3 col-md-4 col-6">
                            ...
                            <select class="form-control select2 a3" id="state-dd" name="state_id" required>
                                <option value="">Select State</option>
                                @foreach($states as $data)
                        ...
                        <div class="form-group  mb-3 col-md-4 col-6">
                            ...
                            <select class="form-control select2 a3" id="city-dd" name="city_id" required>
                        ...
                        <div class="mb-3 col-md-6 col-6 ">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="number" maxlength="6" minlength="6" value="{{old('vendor_pin')}}" name="vendor_pin" class="form-control " placeholder="Ex.123456" required>
                            </div>
                        </div>

                        <div class="mb-3 col-md-6 col-6 ">
                            <label>Credit Days <span class="text-red">*</span></label>
                            <select name="credit_days" class="form-control select2 a3" required>
                                <option>Select Days</option>
                                @foreach($days as $day)
...
<script>
    $(function() {
        ...
        function populateViewModal(data) {
            ...
            $('#vendor_number').text(data.vendor_number);
            $('#vendor_email').text(data.vendor_email);
